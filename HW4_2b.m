...
xlabel('x1'); ylabel('x2');
title('4.2b Exterior Penalty Function method for rp=1'); 
grid minor; hold on;
% Constraints 
g11=[0,0];
g22=[0,0];
...
hold on;
plot (x1_phi_1,x2_phi_1,'*r');
hold on;
legend('Pseudo Function Contour','g1(x)','g2(x)','Stationary Point');
...
xlabel('x1'); ylabel('x2');
title('4.2b Exterior Penalty Function method for rp=10'); 
grid minor; hold on;
% Constraints 
g11=[0,0];
g22=[0,0];
