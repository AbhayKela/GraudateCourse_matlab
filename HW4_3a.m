...
hold on;
xlabel('x1'); ylabel('x2');
title('4.3a Extended interior penalty function method rp_ dash=1'); grid minor;
g11=[0,0];
g22=[0,0];
...
hold on;
legend('Pseudo Objective function','g1','g2')
%% 
figure;
[c,h]= contour(X1,X2,phi_rpd_2,[0,5,10,15,20,25]); clabel(c,h);
hold on;
xlabel('x1'); ylabel('x2');
title('4.3a Extended interior penalty function method rp_ dash=0.1'); grid minor;
g11=[0,0];
g22=[0,0];
c1=contour(X1,X2,G1,g11,'--r');
hold on;
